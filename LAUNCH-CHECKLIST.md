# Launch-Checklist — Ideen auf Probe

Diese Woche: Infrastruktur live bringen, **bevor** der erste echte Cycle startet.

Repo bleibt vorerst `cursor-playground` auf GitHub.
...
- [ ] **Featured** (3 Slots):
  ...
  2. GitHub — Changelog / Version
  3. (Platzhalter für Newsletter ab Woche 6–8)
...
## Woche 6–8: Newsletter

- [ ] Newsletter erstellen: **„Ideen auf Probe"**
- [ ] Rhythmus: 14-tägig, Deutsch
- [ ] Ausgabe #0: Manifest + Curriculum-Visual + Links
- [ ] Launch-Post + Featured Slot 3 aktualisieren

---

## Wenn der erste Cycle startet (Idee vorhanden)

- [ ] [templates/codename-cycle-start.md](./templates/codename-cycle-start.md) durchgehen
- [ ] Codename wählen (z. B. *Projekt Linde*)
- [ ] `cycles/[codename]/README.md` anlegen
- [ ] Cycle-Start-Post auf LinkedIn
- [ ] Monat 1 beginnen — **kein Outreach vor Gate G1**

---

## Sync-Routine (bei jedem Release)

1. GitHub finalisieren + taggen (`v1.x.0`)
2. Geänderte Abschnitte nach Notion kopieren (~30 Min.)
3. LinkedIn-Post: *„Ideen auf Probe v1.x — was sich geändert hat"*
