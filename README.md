...
**Inspiration (Prior Art):** [Startups for the Rest of Us](https://www.startupsfortherestofus.com/), [MicroConf](https://microconf.com/), Rob Wallings 2/20/200- und 5PM-Frameworks — adaptiert für LinkedIn-first Validierung in DACH.
...
```
├── playbook/          # Das Curriculum (Monat 1–6 + Phase 2)
├── templates/         # Kopierbare Vorlagen
├── cycles/            # Ein Ordner pro Codename-Lauf
├── linkedin/          # GTM & Content
├── assets/            # Visuals (Curriculum-Timeline)
├── CHANGELOG.md       # Versionen
└── README.md          # Diese Datei
```

**Source of Truth:** GitHub. Notion ist die hübsche Leseschicht.
